...
?>
    <div class="container-lg px-4" style="min-height: 100vh;">
      <div class="row align-items-center justify-content-center" style="min-height: 100vh;">
        ...
        <div class="col-12 text-center">
          <form method="POST">
            <input type="hidden" name="create_partner">
              <button type="submit" class="btn btn-success btn-sm">dodaj nowy</button>
          </form>
      </div>
    ...
    <form action="" method="POST"  class="row">
      ...
      <div class="col-12 text-center mb-3">
          ...
          <div id="sortable">
          <?php foreach ($data['all_partners'] as $key => $value):?>
            ...
            <div class="col-12 border p-3 my-3">
              <div class="d-flex flex-row">
                ...
                <div class="">
                  ...
                  <a href="/adm_partners/single/<?=$value['id'];?>" class="btn btn-primary btn-sm">edytuj</a>
                </div>
