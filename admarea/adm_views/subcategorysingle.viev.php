          <div class="col-12 my-3 text-center">
            <a href="adm_subcategories/<?=$data['category_row']['category']?>" class="btn btn-success btn-sm mb-3">wróć do podkategorii</a>
              <h5>Edytujesz podkategorię: <?=$data['category_row']['subcategory_display']?></h5>
      ...
      <input type="hidden" name="update_me" value="update_me">
            ...
            <div class="col-12 border p-3 my-3">
              <div class="row px-3">
                ...
                <div class="col-md-6">
                <label for="subcategory_subdisplay" class="form-label">Rozwinięcie</label>
          ...
          $data['prefix'] = 'image';
          $data['form_title'] = 'og_image SUBCATEGORY';
