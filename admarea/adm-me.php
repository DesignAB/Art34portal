    ...
    <div class="container-lg px-4" style="min-height: 100vh;">
      <div class="row align-items-center justify-content-center" style="min-height: 100vh;">
        ...
        <?php $adm_message = $data['messenger']->admMessage();?>
          ...
          <h5 class="ps-1">Zmiana hasła</h5>
          <p class="ps-1 mb-0 text-danger">Zmiana hasła spowoduje wylogowanie z systemu.</p>
          <p class="ps-1 mb-3 text-danger">Zapamiętaj swoje nowe hasło!</p>
                ...
                <form method="POST" enctype="multipart/form-data" class="row g-3 custom-form"  id="register-form" >
                  ...
                  <!-- password -->
                  <div class="col-md-4">
                    <label for="previous_pass" class="form-label">Obecne hasło</label>
                      <div class="input-group input-group-sm mb-3">
                        <input type="password" class="form-control form-control-sm" id="previous_pass" name="previous_pass" required>
                      </div>
                  </div>
                  <div class="col-12">
                  </div>
                  ...
                  <div class="col-md-4">
                    <label for="password_repeat" class="form-label">Potwierdź nowe hasło</label>
          ...
          <h5 class="ps-1 mb-3">Prawa</h5>
                ...
                <form method="POST" enctype="multipart/form-data" class="row g-3 custom-form"  id="register-form" >
                  ...
                  <!-- right -->
                  <div class="col-md-2">
                    <input class="form-check-input" type="checkbox" value="advanced" id="flexCheckChecked" name="advanced" <?= $data['advanced_checked'];?> disabled>
