      ...
      <div class="row align-items-center justify-content-center" style="min-height: 100vh;">
        ...
        <?php $adm_message = $data['messenger']->admMessage();?>
              <div class="col-12 border border-light mb-3 py-3 shadow-sm">
                ...
                <input type="hidden" name="create_partner" value="create_partner">
          ...
          <?php if (!empty($data['all_partners'])):?>
          <?php 
          $counter = 0;
          foreach ($data['all_partners'] as $key => $value):
          ?>
              <!-- content cols-->
              ...
              <div class="col-12 border border-light mb-3 shadow-sm">
                <div class="row p-3">
                  ...
                  <div class="col-md-5 d-flex flex-row align-items-center justify-content-md-end">
                    <button type="button" class="me-1 btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal_<?=$value['id'];?>">
                      usuń
                    </button>
                    <a href="/adm_partners/single/<?=$value['id'];?>" class="btn btn-sm btn-outline-success ms-1">edytuj</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">USUWASZ: <?=$value['partner_name'];?></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

        <form  method="POST" enctype="multipart/form-data" >
          <input type="hidden" name="delete_partner" value="delete_partner">
