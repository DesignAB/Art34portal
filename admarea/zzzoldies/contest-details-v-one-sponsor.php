...
<div class="col-12 separator mt-3"></div>
          ...
          <div class="col-12 border py-3">
          <h5 class="ps-1 mb-3">Sponsor</h5>

                <form method="POST" action="adm-inc/contest-sponsor.inc.php" enctype="multipart/form-data" class="row g-3 custom-form"  id="register-form" >
                  <input type="hidden" id="id" class="form-control form-control-sm" name="id" value="$id">
                  <!-- headers -->
                  <div class="col-md-4">
                    <label for="contest_sponsor_name" class="form-label w-100 ps-1">Nazwa
                    </label>
                    <textarea type="text" name="contest_sponsor_name" class="form-control ps-1" aria-label="With textarea" rows="1" required>$the_contest->contest_sponsor_name</textarea>
                  </div>
                  <div class="col-md-4">
                    <label for="contest_sponsor_sub_name" class="form-label w-100 ps-1">Rozwinięcie nazwy
                    </label>
                    <textarea type="text" name="contest_sponsor_sub_name" class="form-control ps-1" aria-label="With textarea" rows="1" >$the_contest->contest_sponsor_sub_name</textarea>
                  </div>
                  <div class="col-md-4">
                    <label for="contest_sponsor_website" class="form-label w-100 ps-1">Strona WWW
                    </label>
                    <textarea type="text" name="contest_sponsor_website" class="form-control ps-1" aria-label="With textarea" rows="1" >$the_contest->contest_sponsor_website</textarea>
                  </div>
                  <!-- headers -->

                  <div class="col-md-6">
                    <label for="contest_sponsor_short_description" class="form-label w-100 ps-1">Opis skrócony
                    </label>
                    <textarea type="text" name="contest_sponsor_short_description" class="form-control ps-1 trumbowyg-simple" aria-label="With textarea" rows="1" >$the_contest->contest_sponsor_short_description</textarea>
                  </div>
                  <div class="col-md-6">
                    <label for="contest_sponsor_description" class="form-label w-100 ps-1">Opis
                    </label>
                    <textarea type="text" name="contest_sponsor_description" class="form-control ps-1 trumbowyg-with-list" aria-label="With textarea" rows="1" >$the_contest->contest_sponsor_description</textarea>
                  </div>
...
HTML;  
$prefix = 'contest_sponsor_logo'; // name of the image field
// name of image field, record id, table, uploaded photo, back page  form title
$Load_croppie_form2 = new ImageUpload\CroppieFormLoader($prefix, $id, $table, $the_contest->contest_sponsor_logo,'contest-details.php',  'Zdjęcie mobilne');
$Load_croppie_form2->ImageFormLoader();
...
$prefix = 'contest_sponsor_logo'; // name of the image field
// prefix, width, height, decrase viever, image quality
$Load_croppie_script2 = new ImageUpload\CroppieScriptLoader($prefix, 150, 60, 2, 1);
$Load_croppie_script2->ImageScriptLoader();
