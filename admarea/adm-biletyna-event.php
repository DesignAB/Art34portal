  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form method="POST" enctype="multipart/form-data" class="custom-form"  id="delete-form" >
                <input type="hidden" class="form-control" value="<?=$biletyna_event['event_id'];?>" name="event_id">
                <input type="hidden" class="form-control" value="delete_me" name="delete_me">
      </div>
      <div class="modal-footer">
        <button id="delete-button" class="btn btn-sm btn-danger register-button">usuń</button>
...
<!-- delete modal -->
          ...
          <h5 class="ps-1 mb-3">Opcje</h5>
            <form method="POST" enctype="multipart/form-data" class="row g-2 custom-form"  id="register-form" >
                <input type="hidden" class="form-control" value="<?=$biletyna_event['event_id'];?>" name="event_id">
                <input type="hidden" class="form-control" value="<?=$biletyna_event['custom_event_image'];?>" name="custom_event_image">
