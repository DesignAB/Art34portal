...
$this->view("/includes/event-metatags.php", $data);
...
if (!empty($event['custom_event_image'])) {
$image = $event['custom_event_image'];
}
?>

            <div class="col-md-4 px-0 d-flex align-items-center">
            <img src="<?=IMGFOLDER.'events/'.$image;?>" class="img-fluid shadow-sm" alt="...">
            </div>

            <div class="col-md-8 d-flex align-items-center">
                <div class="card-body">
                <h5 class="card-title"><?= $event['artist_name']?></h5>
                <h6 class="card-title text-danger"><?= $event['subheader']?></h6>
                <hr>
